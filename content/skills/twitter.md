---
title: Twitter/X Skill
description: Full Twitter/X integration with research and posting tools
category: skills
---
...
### Research Tools (No API key required)

Uses web search for research without needing X API credentials:
...
### Posting Tools (X API v2 required)

Requires X API OAuth 1.0a credentials:
