---
title: Browser Skill
description: Web browsing with Playwright for AI assistants
category: skills
---

# Browser Skill

Web browsing with Playwright for AI assistants. Works with **Claude Desktop** via MCP, or with Kai.
...
| `screenshot` | Take screenshots (saved to file or base64) |
...
To see browser UI, set `BROWSER_HEADLESS=false`.
