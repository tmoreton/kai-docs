---
title: Docker Skill
description: Docker container management for AI assistants
category: skills
---

# Docker Skill

Docker container management for AI assistants. Works with **Claude Desktop** via MCP, or with Kai.
