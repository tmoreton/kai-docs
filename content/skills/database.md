...
description: Database operations including migrations, queries, and schema inspection
category: skills
---
...
```
Check migration status for Prisma
```
...
```
Inspect schema and generate TypeScript types
```
